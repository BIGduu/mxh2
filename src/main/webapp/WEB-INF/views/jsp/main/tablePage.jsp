			...
			<ul class="pagination">
				<c:if test="${page > 1}">
 				<li class="paginate_button previous" aria-controls="DataTables_Table_1" tabindex="0" id="DataTables_Table_1_previous">
 					<a href="#" onclick="goList(${page-1})"><i class="fa fa-angle-left"></i></a>
 				</li>
				</c:if>
				<c:if test="${page <= 1}">
				...
				<c:if test="${page == total && (page - 4) >= 1}">
					<li class="paginate_button " aria-controls="DataTables_Table_1" tabindex="0"><a href="#" onclick="goList(${page-4})">${page-4}</a></li>
				</c:if>
				<c:if test="${(page == total || page == total-1) && (page - 3) >= 1}">
					<li class="paginate_button " aria-controls="DataTables_Table_1" tabindex="0"><a href="#" onclick="goList(${page-3})">${page-3}</a></li>
				</c:if>
				<c:if test="${(page - 2) >= 1}">
					<li class="paginate_button " aria-controls="DataTables_Table_1" tabindex="0"><a href="#" onclick="goList(${page-2})">${page-2}</a></li>
				</c:if>
				<c:if test="${(page - 1) >= 1}">
					<li class="paginate_button " aria-controls="DataTables_Table_1" tabindex="0"><a href="#" onclick="goList(${page-1})">${page-1}</a></li>
				</c:if>
				...
				<c:if test="${page < total}">
					<li class="paginate_button next" aria-controls="DataTables_Table_1" tabindex="0" id="DataTables_Table_1_next"><a href="#" onclick="goList(${page+1})"><i class="fa fa-angle-right"></i></a></li>
				</c:if>
			</ul>
		</div>
	</div>
