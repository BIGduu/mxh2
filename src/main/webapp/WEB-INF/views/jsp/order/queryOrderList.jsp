...
<div class="content">
                                    ...
                                    <c:choose>
                                        <c:when test="${delivery.id == deliveryId }">
                                            <option value="${delivery.id }"
                                                    selected="selected">${delivery.name }</option>
                                        </c:when>
                                        <c:otherwise>
    ...
    <table class="table table-bordered table-striped js-dataTable-simple dataTable no-footer" id="DataTables_Table_1"
        ...
        <tr role="row">
            ...
            <th class="sorting_disabled" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1"
                aria-sort="ascending" aria-label=": activate to sort column descending" style="width: 100px;">是否上楼
            </th>
...
<script type="text/javascript">
    ...
    function goList(page) {
        goMenu("/admin/order/queryOrderList", page, $("#searchForm").serialize());
    }
    ...
    function orderMenuList(orderId, orderName) {
        ajax({
            type: "POST",
            dataType: "html",
            url: "/admin/order/queryOrderList?page=${page}&orderId=" + orderId,
            timeout: 5000,
            data: {
                orderName: orderName
            },
