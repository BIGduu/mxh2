    ...
    <div class="row items-push">
        <div class="col-sm-7">
            <h1 class="page-heading">
                <small><a onclick="goMain()">首页</a> > <a onclick="goList(${page})" style="cursor: pointer;">部门管理  </a> >部门<c:if test="${not empty department}">编辑</c:if><c:if test="${empty department}">新增</c:if></small>
            </h1>
        </div>
    </div>
</div>
...
<div class="content">
    <div class="col-md-12">
        <form autocomplete="off" class="form-horizontal push-10-t" action="" method="post" onsubmit="return departmentSave();" id="departmentForm">         
            <div class = "row">
	           <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
		            <div class="form-group">
		                <div class="col-sm-10 col-xs-12">
		                   ...
		                   <div>
	                        	<input class="form-control" type="text" id="departmentName" name="departmentName" placeholder="" value="${departmentName}">
	                        </div>
	                    </div>
	                </div>
	            </div>
...
function departmentSave()
{
	...
	ajax({
		type: "POST",
        dataType: "json",
        url: "/admin/department/departmentSave?id=${departmentId}",
